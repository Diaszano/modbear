...
- [x] **Step 1: Add failing package-policy assertions to `scripts/test-release-config.mjs`**
...
- [x] **Step 2: Run the policy test to prove the baseline is not yet adopted**
...
- [x] **Step 3: Add a failing VSIX contract test**
...
- [x] **Step 4: Run the new contract test to prove it fails before the allowlist is fixed**

  Run: `rtk npm run test:package`

  Expected: FAIL because the current `.vscodeignore` is not an explicit ModBear allowlist.

- [x] **Step 5: Commit the red policy tests for task-scoped review**
...
- [x] **Step 1: Set the runtime and compiler contracts**
...
- [x] **Step 2: Replace the JavaScript build script with typed build configuration**
...
- [x] **Step 3: Add the required development dependencies and scripts**
...
- [x] **Step 4: Run the type and policy checks**
...
- [x] **Step 5: Commit the runtime and build foundation**
...
- [x] **Step 1: Add the flat, type-aware ESLint configuration**
...
- [x] **Step 2: Add deterministic Prettier policy and scripts**
...
- [x] **Step 3: Add the Commitlint hook and make mechanical fixes**
...
- [x] **Step 4: Verify developer quality commands**
...
- [x] **Step 5: Commit the standardization layer**
...
- [x] **Step 1: Expand `.gitignore` without ignoring checked-in project policy**
...
- [x] **Step 2: Replace `.vscodeignore` with deny-by-default rules**
...
- [x] **Step 3: Remove only tracked local agent files from Git's index**
...
- [x] **Step 4: Test ignore and packaging contracts**
...
- [x] **Step 5: Commit package hygiene**
...
- [x] **Step 1: Pin CI actions and remove registry-dependent audit**
...
- [x] **Step 2: Make quality checks explicit in `ci.yml`**
...
- [x] **Step 3: Harden PR-title and release behavior**
...
- [x] **Step 4: Extend and run workflow policy tests**
...
- [x] **Step 5: Commit CI/CD hardening**
...
- [x] **Step 1: Add ownership and Dependabot configuration**
...
- [x] **Step 2: Create ModBear-specific PR and issue templates**
...
- [x] **Step 3: Add governance assertions and execute them**
...
- [x] **Step 4: Commit governance policy**
...
- [x] **Step 1: Install from the committed lockfile under Node 24**

  Run: `rtk npm ci`

  Expected: PASS without lockfile changes.

- [x] **Step 2: Execute every local quality gate**
...
- [x] **Step 3: Verify static delivery invariants**
...
- [x] **Step 4: Route any correction to its owning task before committing**
