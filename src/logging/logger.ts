...
export class Logger implements vscode.Disposable {
  ...
  public info(message: string): void { this.event("info", "log", { message }); }
  public warn(message: string): void { this.event("warn", "log", { message }); }
  public error(message: string): void { this.event("error", "log", { message }); }
